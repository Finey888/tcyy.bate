...
class Brandslide extends Common
{
    ...
    public function __construct(Request $request = null,$options = [])
    {
        ...
        $this->model = new \app\index\model\BrandSlide();
    }
    ...
    public function uploadImg(){
        ...
        return uploadImg($file, '/upload/brandslide/images/');
    }
