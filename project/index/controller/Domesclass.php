...
//演示库分类
class Domesclass extends Common
{
    private $model;
    public function __construct(Request $request = null,$options = [])
    {
        parent::__construct($request);
        $this->model = new \app\index\model\DomeGroup();
    }
    
    public function index()
    {
        return view('Domesclass/index');
    }
