...
layui.config({
    ...
    function lockPage() {
        ...
        layer.open({
            ...
            '<div class="admin-header-lock-img"><img src="/admin/images/face.jpg"/></div>' +
    ...
    function setLockPsw() {
        ...
        layer.open({
            ...
            '<div class="admin-header-lock-name" id="lockUserName">' + username + '</div>' +
            '<div class="input_btn">' +
            '<input type="password" class="admin-header-lock-input layui-input" autocomplete="off" placeholder="请设置锁屏密码" name="lockPwd" id="setlockPwd" />' +
            '<button class="layui-btn" id="setlock">确定</button>' +
            '</div>' +
            '</div>',
            closeBtn: 0,
            shade: 0.9
    ...
    $("body").on("click", "#setlock", function () {
        setlockPwd = $('#setlockPwd').val();
        if (setlockPwd == "") {
            layer.msg("密码不能为空!");
            return false;
        }
        window.sessionStorage.setItem("lockPassword", setlockPwd);
    ...
    $("body").on("click", "#unlock", function () {
        if ($(this).siblings(".admin-header-lock-input").val() == '') {
            ...
            setlockPwd = window.sessionStorage.getItem("lockPassword");
            if ($(this).siblings(".admin-header-lock-input").val() == setlockPwd) {
