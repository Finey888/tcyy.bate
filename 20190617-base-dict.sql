...
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','1','口腔护士','1','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','2','全科医师','2','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','3','洽谈师','3','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','4','儿童牙科','4','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','5','口腔正畸','5','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','6','口腔种植','6','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('positionType','7','口腔内科','7','职位类型');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('education','0','应届毕业生','1','学历');
...
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('salaryRange','0','面议','0','薪酬范围');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('salaryRange','1','3000以下','1','薪酬范围');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('salaryRange','2','3000-5000','2','薪酬范围');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('salaryRange','3','5000-10000','3','薪酬范围');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('salaryRange','4','10000-20000','4','薪酬范围');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('salaryRange','5','20000以上','5','薪酬范围');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('peopleScope','1','0-20','1','人员规模');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('peopleScope','2','21-99','2','人员规模');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('peopleScope','3','21-99','3','人员规模');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('peopleScope','4','500-1000','4','人员规模');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('peopleScope','5','1000-9999','5','人员规模');
...
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('jobPosition','100','口腔医生','1','工作职位名称');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('jobPosition','200','口腔正畸方案设计师','2','工作职位名称');
insert into `tcyy_base_dict` ( `dict_code`, `dict_value`, `dict_name`, `dict_sort`, `remark`) values('jobPosition','300','牙科医生','3','工作职位名称');
